...
#             print("{}/{}".format(self.image_dir, image['file_name']))
            print(image_path)
...
# for instance in range(12,21):
# #     annotation_path = os.path.join(r"E:\Challenge\MaskR-CNN", "{:04}.json".format(instance))
# #     image_dir = os.path.join(r"E:\Challenge\KITTI_MOTS\training\image_02", "{:04}".format(instance))
# #
...
# #
# #     html = coco_dataset.display_image(50, use_url=False)
# #     file = open("{:04}.html".format(instance), mode='w')
# #     data = file.write(html)
